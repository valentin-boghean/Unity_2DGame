...
namespace ilhamhe {
	...
	public class DynamicWater2D : MonoBehaviour {
		...
		private void GenerateMesh () {
			...
			this.gameObject.GetComponent<Renderer>().sortingLayerName = parentRender.sortingLayerName;
			this.gameObject.GetComponent<Renderer>().renderingLayerMask = parentRender.renderingLayerMask;
			this.gameObject.GetComponent<Renderer>().sortingLayerID = parentRender.sortingLayerID;
